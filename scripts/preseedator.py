...
from ScibianHPCNetboot import NetbootAppPreseed, run_app

""" Scibian HPC Preseedator: debian-installer preseed generator for Scibian HPC
    clusters. """


def main():

    run_app(NetbootAppPreseed)
